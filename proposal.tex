...
%%
\title{Proposal: \protect\\ Toward the fast development of \protect\\ highly dynamic controllers \protect\\ for humanoid characters} %% If you want to specify a linebreak
